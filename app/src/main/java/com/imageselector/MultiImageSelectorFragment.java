...
import com.imageselector.adapter.FolderAdapter;
import com.imageselector.adapter.ImageGridAdapter;
import com.imageselector.bean.Folder;
import com.imageselector.bean.Image;
import com.imageselector.utils.FileUtils;
import com.imageselector.utils.ScreenUtils;
    ...
    private void showCameraAction() {
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                Toast.makeText(getActivity(), "未找到相机", Toast.LENGTH_SHORT).show();
            }
        }
    }
