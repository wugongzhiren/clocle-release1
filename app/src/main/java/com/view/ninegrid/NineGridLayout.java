...
//        params.width = width;
    ...
    private int getListSize(String[] list) {
    ...
    protected abstract void onClickImage(int position, String url, String[] urlList);
}
