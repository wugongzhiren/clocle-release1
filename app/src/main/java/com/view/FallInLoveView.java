...
public class FallInLoveView extends FrameLayout {

    public static final String TAG = FallInLoveView.class.getSimpleName();
    ...
    public FallInLoveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //initAttrs(context, attrs);
    }

    public FallInLoveView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
       // initAttrs(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public FallInLoveView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
